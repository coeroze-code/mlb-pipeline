...
def _rating_color(series):
    """Light-to-dark green highlight scaled to the Rating column's own
    min/max, with no dependency beyond pandas itself (avoids matplotlib,
    which pandas' built-in background_gradient requires and which isn't
    ...
    for v in series:
        ...
        r = round(255 + frac * (46 - 255))
        g = round(255 + frac * (139 - 255))
        b = round(255 + frac * (87 - 255))
...
if os.path.exists(CSV_PATH):
    ...
    styled = shown.style.apply(_rating_color, subset=["Rating"])
